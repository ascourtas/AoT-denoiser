...
MONTHLY_AOT_DIR="../data/chicago-complete.monthly.2019-04-01-to-2019-04-30"
...
gunzip ../data/$MONTHLY_AOT_DIR/data.csv.gz
echo "1/7: Unzipped data file"
#tar -xvf $MONTHLY_AOT
#echo "1/7: Unzipped data file"

#make a copy to save just in case, drop stuff from drop file
cp ../data/$MONTHLY_AOT_DIR/data.csv ../data/$MONTHLY_AOT_DIR/data_backup.csv
echo "2/7: Copy Done"
...
python3 drop_unneeded_variables.py ../data/$MONTHLY_AOT_DIR/data.csv ../data/$MONTHLY_AOT_DIR/data_drop.csv
...
sed '1s/.*/timestamp,node_id,subsystem,sensor,parameter,value_hrf,value_raw/' ../data/$MONTHLY_AOT_DIR/data_drop.csv > ../data/$MONTHLY_AOT_DIR/data_head_diff.csv
echo "4/7: Changed header"

#save original dataset with original
cp ../data/$MONTHLY_AOT_DIR/data.csv ../data/$MONTHLY_AOT_DIR/data_original.csv
echo "5/7: Saved original dataset"

# make the new headed dataset the target for the next scripts 
mv ../data/$MONTHLY_AOT_DIR/data_head_diff.csv ../data/$MONTHLY_AOT_DIR/data.csv
echo "6/7: Manipulating dataset"

#Actually reduce the timestep of the 6 month dataset
python3 ../../data-tools/data-reduction-tool/dataReduction.py -v 10000 -i ../data/$MONTHLY_AOT_DIR/ -t 30m
