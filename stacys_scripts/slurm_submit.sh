...
mv /projects/b1045/AoT/$NEW_DIR/data.csv /projects/b1045/AoT/$NEW_DIR /data_original.csv
echo "5/7: Saved original dataset"

# make the new headed dataset the target for the next scripts 
mv /projects/b1045/AoT/$NEW_DIR/data_head_diff.csv /projects/b1045/AoT/$NEW_DIR/data.csv
echo "6/7: Manipulating dataset"

#Actually reduce the timestep of the 6 month dataset
python3 /home/asm0384/AoT_processing/data-tools.git/trunk/data-reduction-tool/dataReduction.py -v 10000 -i /projects/b1045/AoT/$NEW_DIR/ -t 30m
